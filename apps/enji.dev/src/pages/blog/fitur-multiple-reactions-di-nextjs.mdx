...
- `sessionId`
  ...
  Atau kalau mau inspect langsung juga gasss [kesini](https://github.com/).
...
Bingung ya? hehe maaf, coba cek [full kodenya](https://github.com/).
...
Tapi kayanya bakal update di [Twitter](https://twitter.com/), ngga bakal dibikinin postingan khusus.
