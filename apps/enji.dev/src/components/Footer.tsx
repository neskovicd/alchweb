...
function Footer() {
  return (
    <footer
      className={clsx(
        'background-grid background-grid--fade-in border-divider-light mt-24 pt-4 text-sm text-slate-900',
        'dark:border-divider-dark border-t-2 dark:text-slate-200 '
      )}
    >
      <div className={clsx('content-wrapper')}>
        ...
        >
          <div className={clsx('font-semibold')}>
            &copy; {dayjs().format('YYYY')}, Alchemy Studio
          </div>
